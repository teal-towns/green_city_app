...
class _BlogSaveState extends State<BlogSave> {
            ...
            child: Container(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ImageSaveComponent(formVals: formVals, formValsKey: 'image_url', multiple: false,
                      label: 'Image', imageUploadSimple: true, maxImageSize: 1200),
                    SizedBox(height: 10),
                    _inputFields.inputText(context, formVals, 'image_credit', label: 'Image Credit', required: false),
                    SizedBox(height: 20),
  ...
  void setFormVals(BlogClass blog) {
    ...
    formVals['image_url'] = blog.image_url;
    formVals['image_credit'] = blog.image_credit;
  ...
  bool formValid() {
    ...
    if (!formVals.containsKey('image_url') || formVals['image_url'].length < 1) {
      return false;
    }
    return true;
  }
